...
{
	/// <summary>
	/// Файл admModelTableRht.cs
	/// </summary>
	/// <remarks>Класс - Cущность 'Права'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admModelTableRht : datUnitModelTable
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fDescription = datApplication.__oTunes.__mTranslate("Права");
			__oEssence = new admEssenceRht("Main", DELETETYPES.Mark); // Сущность таблицы
			__fName = "Rht";
		...
		public override void __mModelTableBuilding()
		{
			...
			/// dsiRht - Название
			{
				...
				vField.__fIsNull = false;
				vField.__fDataType = COLUMNSTYPES.Nvarchar;
				vField.__fName = "dsiRht";
				vField.__fDescription = "Название";
				__fFieldS.Add(vField);
			}

			/// FrmNam - Название формы
			{
				vField = new datUnitModelField();
				vField.__fAutoIncrement = false;
				vField.__fIsClue = false;
				vField.__fCaption = "Название формы";
				vField.__fIsNull = false;
				vField.__fDataType = COLUMNSTYPES.Nvarchar;
				vField.__fName = "FrmNam";
				vField.__fDescription = "Название формы";
				__fFieldS.Add(vField);
			}
