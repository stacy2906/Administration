...
{
	/// <summary>
	/// Файл admModelTableCpu.cs
	/// </summary>
	/// <remarks>Класс - Cущность 'Компьютеры'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admModelTableCpu : datUnitModelTable
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fDescription = datApplication.__oTunes.__mTranslate("Компьютеры");
			__oEssence = new admEssenceCpu("Main", DELETETYPES.Mark); // Сущность таблицы
			__fName = "Cpu";
