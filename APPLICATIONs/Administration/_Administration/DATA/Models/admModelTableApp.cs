...
{
	/// <summary>
	/// Файл admModelTableApp.cs
	/// </summary>
	/// <remarks>Класс - Cущность 'Приложения'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admModelTableApp : datUnitModelTable
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fDescription = datApplication.__oTunes.__mTranslate("Приложения");
			__oEssence = new admEssenceApp("Main", DELETETYPES.Mark); // Сущность таблицы
			__fName = "App";
		...
		public override void __mModelTableBuilding()
		{
			...
			/// dsiApp - Название
			{
				...
				vField.__fName = "dsiApp";
				vField.__fDescription = "Название";
				__fFieldS.Add(vField);
			}

			/// Pfx - Префикс файлов приложения
			{
				vField = new datUnitModelField();
				vField.__fAutoIncrement = false;
				vField.__fIsClue = false;
				vField.__fCaption = "Префикс файлов приложения";
				vField.__fIsNull = false;
				vField.__fDataType = COLUMNSTYPES.Nchar;
				vField.__fName = "Pfx";
				vField.__fDescription = "Префикс файлов приложения";
				__fFieldS.Add(vField);
			}
