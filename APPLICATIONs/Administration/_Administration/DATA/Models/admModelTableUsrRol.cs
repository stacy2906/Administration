...
{
	/// <summary>
	/// Файл admModelTableUsrRol.cs
	/// </summary>
	/// <remarks>Класс - Cущность 'Роли пользователей'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admModelTableUsrRol : datUnitModelTable
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fDescription = datApplication.__oTunes.__mTranslate("Роли пользователей");
			__oEssence = new admEssenceUsrRol("Main", DELETETYPES.Mark); // Сущность таблицы
			__fName = "UsrRol";
