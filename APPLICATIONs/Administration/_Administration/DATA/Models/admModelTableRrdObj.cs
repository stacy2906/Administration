...
{
	/// <summary>
	/// Файл admModelTableRrdObj.cs
	/// </summary>
	/// <remarks>Класс - Cущность 'Объект блокировки'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admModelTableRrdObj : datUnitModelTable
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fDescription = datApplication.__oTunes.__mTranslate("Объект блокировки");
			__oEssence = new admEssenceRrdObj("Main", DELETETYPES.Mark); // Сущность таблицы
			__fName = "RrdObj";
