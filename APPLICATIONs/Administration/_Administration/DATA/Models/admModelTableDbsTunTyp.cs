...
{
	/// <summary>
	/// Файл admModelTableDbsTunTyp.cs
	/// </summary>
	/// <remarks>Класс - Cущность 'Виды настроек базы данных'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admModelTableDbsTunTyp : datUnitModelTable
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fDescription = datApplication.__oTunes.__mTranslate("Виды настроек базы данных");
			__oEssence = new admEssenceDbsTunTyp("Main", DELETETYPES.Mark); // Сущность таблицы
			__fName = "DbsTunTyp";
		...
		public override void __mModelTableBuilding()
		{
			...
			/// cgzDbsTunTyp - Сортировка
			{
				...
				vField.__fIsNull = false;
				vField.__fDataType = COLUMNSTYPES.Int;
				vField.__fName = "cgzDbsTunTyp";
				vField.__fDescription = "Сортировка";
				__fFieldS.Add(vField);
			}

			/// dsiDbsTunTyp - Название
			{
				vField = new datUnitModelField();
				vField.__fAutoIncrement = false;
				vField.__fIsClue = false;
