...
{
	/// <summary>
	/// Файл admFormFilterUsrRol.cs
	/// </summary>
	/// <remarks>Класс формы для построения фильтра 'Роли пользователей'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admFormFilterUsrRol : elmFormFilter
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fCaption_ = "Фильтр ролей пользователей";
			_fHelpTopic = "";
			// _cInputELD
			{
