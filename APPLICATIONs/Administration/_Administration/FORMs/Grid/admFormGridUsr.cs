...
{
	/// <summary>
	/// Файл admFormGridUsr.cs
	/// </summary>
	/// <remarks>Класс формы для правки сущности 'Пользователи'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admFormGridUsr : elmFormGrid
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fCaption_ = "Пользователи";
			_fHelpTopic = "";

			// __cAreaGrid
			{
				__cAreaGrid.__fButtonEditCopyVisible_ = false;
				__cAreaGrid.__oEssence_ = new admEssenceUsr();
				__cAreaGrid.__oFormFilter = typeof(admFormFilterUsr);
				__cAreaGrid.__oFormOpened = typeof(admFormRecordUsr);
				...
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Запись: Идентификатор")
					...
					, false
					, DATAGRIDCOLUMNTYPE.DataGridViewTextBoxColumn);
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Код")
					, elmApplication.__oTunes.__mTranslate("Учетный код. Порядковый номер") + "."
					, "codUsr"
					, true
					, true
					, DATAGRIDCOLUMNTYPE.DataGridViewTextBoxColumn);
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Псевдоним")
					, ""
					, "dsiUsr"
					, true
					, true
					, DATAGRIDCOLUMNTYPE.DataGridViewTextBoxColumn);
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Метка: Администратор")
					, ""
					, "mrkAdm"
					, true
					, true
					, DATAGRIDCOLUMNTYPE.DataGridViewCheckBoxColumn);
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Пароль")
					, ""
					, "PswCod"
					, true
					, true
