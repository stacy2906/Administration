...
{
	/// <summary>
	/// Файл admFormGridSrv.cs
	/// </summary>
	/// <remarks>Класс формы для правки сущности 'Сервера'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admFormGridSrv : elmFormGrid
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			// __cAreaGrid
			{
				...
				__cAreaGrid.__oEssence_ = new admEssenceSrv();
				__cAreaGrid.__oFormFilter = typeof(admFormFilterSrv);
				__cAreaGrid.__oFormOpened = typeof(admFormRecordSrv);
				...
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Название")
					...
					, true
					, DATAGRIDCOLUMNTYPE.DataGridViewTextBoxColumn);
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Электронная почта")
					, ""
					, "Eml"
					, true
					, true
