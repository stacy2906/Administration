...
{
	/// <summary>
	/// Файл admFormGridUsrRol.cs
	/// </summary>
	/// <remarks>Класс формы для правки сущности 'Роли пользователей'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admFormGridUsrRol : elmFormGrid
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fCaption_ = "Роли пользователей";
			_fHelpTopic = "";

			// __cAreaGrid
			{
				__cAreaGrid.__fButtonEditCopyVisible_ = false;
				__cAreaGrid.__oEssence_ = new admEssenceUsrRol();
				__cAreaGrid.__oFormFilter = typeof(admFormFilterUsrRol);
				__cAreaGrid.__oFormOpened = typeof(admFormRecordUsrRol);
