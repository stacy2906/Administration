...
{
	/// <summary>
	/// Файл admFormGridDbs.cs
	/// </summary>
	/// <remarks>Класс формы для правки сущности 'Базы данных'</remarks>
	/// <design>Код класса сгенерирован программой 'CS Designer'</design>
	public class admFormGridDbs : elmFormGrid
	{
		#region = МЕТОДЫ
		...
		protected override void _mObjectAssembly()
		{
			...
			__fCaption_ = "Базы данных";
			_fHelpTopic = "";

			// __cAreaGrid
			{
				__cAreaGrid.__fButtonEditCopyVisible_ = false;
				__cAreaGrid.__oEssence_ = new admEssenceDbs();
				__cAreaGrid.__oFormFilter = typeof(admFormFilterDbs);
				__cAreaGrid.__oFormOpened = typeof(admFormRecordDbs);
				...
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Название")
					...
					, true
					, DATAGRIDCOLUMNTYPE.DataGridViewTextBoxColumn);
				__cAreaGrid.__mColumnAdd(elmApplication.__oTunes.__mTranslate("Ссылка: Сервер")
					, ""
					, "desSrv"
					, true
					, true
