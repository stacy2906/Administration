...
namespace naCsManual
{
    ...
    internal class cmlFormMain : elmForm
    {
        ...
        protected override void _mObjectAssembly()
        {
            ...
            // _cButtonRun
            {
                _cButtonRun.Image = global::nlResourcesImages.Properties.Resources._Signtick_g32C;
            ...
            // _cFolderScan
            {
                ...
                _cFolderScan.__fPathType = PATHTYPES.Directory;
        ...
        private void _cButtonRun_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                vError.__fErrorsType_ = ERRORSTYPES.User;
