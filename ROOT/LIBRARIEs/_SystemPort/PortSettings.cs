...
namespace nlSystemPort.Serial
{
    ...
    public class BasicPortSettings
    {
        ...
        public System.Collections.ArrayList SettingList;

        public BasicPortSettings()
        {


        }

        /*public System.Collections.ArrayList BasicSettings {
    ...
    public class DetailedPortSettings
    {
        ...
        {
            BasicSettings.BaudRate = BaudRates.CBR_115200;
