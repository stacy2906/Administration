...
namespace nlSystemPort.Serial
{
    ...
    internal abstract class CommAPI
    {
        ...
        //internal virtual bool WriteFile(IntPtr hPort, byte[] buffer, int cbToWrite, ref Int32 cbWritten, IntPtr lpOverlapped) {return false;}
        internal virtual bool WriteFile(IntPtr hPort, byte[] buffer, UInt32 cbToWrite, ref Int32 cbWritten, IntPtr lpOverlapped) { return false; }
        ...
        //internal virtual bool WriteFile(IntPtr hPort, byte[] buffer, Int32 cbToWrite, ref Int32 cbWritten, ref OVERLAPPED lpOverlapped) {return false;}

        //internal virtual bool ReadFile(IntPtr hPort, byte[] buffer, Int32 cbToRead, ref Int32 cbRead, ref OVERLAPPED lpOverlapped) {return false;}
        ...
        #region Helper Property - FullFramework
    ...
    {
        #region Common override Serial COM functions needed

        override internal IntPtr CreateFile(string FileName)
        {
            //return WinCreateFileW(FileName, CreateAccess, 0, IntPtr.Zero, OPEN_EXISTING, FILE_FLAG_OVERLAPPED, IntPtr.Zero);
            return WinCreateFileW(FileName, CreateAccess, 0, IntPtr.Zero, OPEN_EXISTING, 0, IntPtr.Zero);

        }

        //override internal bool ReadFile(IntPtr hPort, byte[] buffer, Int32 cbToRead, ref Int32 cbRead, ref OVERLAPPED lpOverlapped) 
        override internal bool ReadFile(IntPtr hPort, byte[] buffer, Int32 cbToRead, ref Int32 cbRead, IntPtr lpOverlapped)
        {
            //return Convert.ToBoolean(WinReadFile(hPort, buffer, cbToRead, ref cbRead, ref lpOverlapped));
            return Convert.ToBoolean(WinReadFile(hPort, buffer, cbToRead, ref cbRead, IntPtr.Zero));

        }

        //override internal bool WriteFile(IntPtr hPort, byte[] buffer, Int32 cbToWrite, ref Int32 cbWritten, IntPtr lpOverlapped) {
        //override internal bool WriteFile(IntPtr hPort, byte[] buffer, Int32 cbToWrite, ref Int32 cbWritten, ref OVERLAPPED lpOverlapped) {

        override internal bool WriteFile(IntPtr hPort, byte[] buffer, UInt32 cbToWrite, ref Int32 cbWritten, IntPtr lpOverlapped)
        {

            return Convert.ToBoolean(WinWriteFile(hPort, buffer, cbToWrite, ref cbWritten, IntPtr.Zero));

            //return Convert.ToBoolean(WinWriteFile(hPort, buffer, cbToWrite, ref cbWritten, ref lpOverlapped));
        }
        ...
        #region Uncommon override functions not needed	
        ...
        #region Win32 File I/O API imports
		...
		*/
        ...
        private static extern IntPtr WinCreateFileW
            (
            String lpFileName,
        ...
        private static extern int WinWriteFile(IntPtr hFile, byte[] lpBuffer, UInt32 nNumberOfBytesToWrite, ref Int32 lpNumberOfBytesWrite, IntPtr lpOverlapped);

        //private  static extern int WinWriteFile(IntPtr hFile, byte[] lpBuffer, Int32 nNumberOfBytesToWrite, ref Int32 lpNumberOfBytesWrite, IntPtr lpOverlapped);
        //private  static extern int WinWriteFile(IntPtr hFile, byte[] lpBuffer, Int32 nNumberOfBytesToWrite, ref Int32 lpNumberOfBytesWrite, ref OVERLAPPED lpOverlapped);
        ...
        //private static extern int WinReadFile(IntPtr hFile, byte[] lpBuffer, Int32 nNumberOfBytesToRead, ref Int32 lpNumberOfBytesRead,ref OVERLAPPED lpOverlapped);
        private static extern int WinReadFile(IntPtr hFile, byte[] lpBuffer, Int32 nNumberOfBytesToRead, ref Int32 lpNumberOfBytesRead, IntPtr lpOverlapped);
