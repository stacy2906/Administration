...
namespace nlElements
{
	...
	public class elmTypeSelection
	{
		...
		public elmTypeSelection(TextBoxBase textBox)
		{
			m_textBox = textBox;
		}
		...
		/// <seealso cref="System.Windows.Forms.TextBoxBase" />	
		public elmTypeSelection(TextBoxBase textBox, int start, int end)
		{
			m_textBox = textBox;
			Set(start, end);
		}
		...
		/// <seealso cref="MoveBy" />	
		/// <seealso cref="Set" />	
		public static elmTypeSelection operator+(elmTypeSelection selection, int pos)
		{
			return new elmTypeSelection(selection.m_textBox, selection.Start + pos, selection.End + pos);
		}			
		...
		public class Saver : IDisposable
		{
			// Fields
			private TextBoxBase m_textBox;
			private elmTypeSelection m_selection;
			...
			{
				m_textBox = textBox;
				m_selection = new elmTypeSelection(textBox);
