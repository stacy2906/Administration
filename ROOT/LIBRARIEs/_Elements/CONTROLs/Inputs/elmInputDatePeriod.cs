...
{
    /// <summary>
    /// Файл elmInputDatePeriod.cs
    /// </summary>
    /// <remarks>Класс-поле ввода значений периода даты-времени</remarks>
    /// <conception>Lucasin V.</conception> // Замысел
    /// <version>2026.02.11 09-15</version> // Дата-время последней корректировки
    public class elmInputDatePeriod : elmInput
    {
        #region = ДИЗАЙНЕРЫ
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void mLabelCaption_MouseClickRight(object sender, System.EventArgs e)
        {
            _cInput.__fValue_ = appTypeDateTime.__mDayBegin(DateTime.Now);
        ...
        /// </summary>
        protected elmComponentDate _cInputTo = new elmComponentDate();
